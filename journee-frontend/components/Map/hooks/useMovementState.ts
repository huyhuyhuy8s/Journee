...
import { STATE_STABILITY_CONFIG, MOVEMENT_STATES } from "../utils/constants";
import { getNotificationColor } from "../utils/movementStateUtils";
import { getIntervalText } from "../utils/locationUtils";
